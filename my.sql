...
/*!50001 CREATE TABLE `v_emp` (
  ...
  `in_dpt` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_tmp`
--

DROP TABLE IF EXISTS `v_tmp`;
/*!50001 DROP VIEW IF EXISTS `v_tmp`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_tmp` (
  `id` tinyint NOT NULL,
  `name` tinyint NOT NULL,
  `age` tinyint NOT NULL,
  `salary` tinyint NOT NULL,
...
/*!50001 VIEW `v_emp` AS select `employee`.`id` AS `id`,`employee`.`name` AS `name`,`employee`.`age` AS `age`,`employee`.`salary` AS `salary`,`employee`.`phone` AS `phone`,`employee`.`in_dpt` AS `in_dpt` from `employee` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_tmp`
--

/*!50001 DROP TABLE IF EXISTS `v_tmp`*/;
/*!50001 DROP VIEW IF EXISTS `v_tmp`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_tmp` AS select `employee`.`id` AS `id`,`employee`.`name` AS `name`,`employee`.`age` AS `age`,`employee`.`salary` AS `salary`,`employee`.`phone` AS `phone`,`employee`.`in_dpt` AS `in_dpt` from `employee` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-04-13 21:19:58
